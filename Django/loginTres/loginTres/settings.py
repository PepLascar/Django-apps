"""
Django settings for loginTres project.
...
SECRET_KEY = 'django-insecure-7#%d1(d6!x+r*&m!o=@rgc=kay^tj)9#4qhqo^#t7l+jj-^7ms'
...
WSGI_APPLICATION = 'loginTres.wsgi.application'
